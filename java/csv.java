...
public class csv {
    ...
    public static void main(String[] args) {
        ...
        CSV.Field[] fields = new CSV.Field[5]; // [['int', 5, 10], ['float', 4, 6], ['alphabets_lower_Case', 5], ['alphabets_upper_Case', 7], ['random_string', 4]].
        fields[0] = new Field("int", 5, 10);
        fields[1] = new Field("float", 4, 6);
        fields[2] = new Field("alphabets_lower_Case", 5);
        fields[3] = new Field("alphabets_upper_Case", 7);
        fields[4] = new Field("random_string", 4);
        generate_random_csv("../Results/Java/3.csv", ",", fields, 20000);
    }
} 
